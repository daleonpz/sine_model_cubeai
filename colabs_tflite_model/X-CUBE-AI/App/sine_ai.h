...
#include "sine_ai_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINE_AI_MODEL_NAME          "sine_ai"
#define AI_SINE_AI_ORIGIN_MODEL_NAME   "sine_model"

/******************************************************************************/
#define AI_SINE_AI_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_SINE_AI_IN_NUM        (1)
#define AI_SINE_AI_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_AI_IN_SIZE { \
  AI_SINE_AI_IN_1_SIZE, \
}
#define AI_SINE_AI_IN_SIZE_BYTES { \
  AI_SINE_AI_IN_1_SIZE_BYTES, \
}
#define AI_SINE_AI_IN_1_CHANNEL     (1)
#define AI_SINE_AI_IN_1_SIZE        (1)
#define AI_SINE_AI_IN_1_SIZE_BYTES  (AI_SINE_AI_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_AI_OUT_NUM       (1)
#define AI_SINE_AI_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_AI_OUT_SIZE { \
  AI_SINE_AI_OUT_1_SIZE, \
}
#define AI_SINE_AI_OUT_SIZE_BYTES { \
  AI_SINE_AI_OUT_1_SIZE_BYTES, \
}
#define AI_SINE_AI_OUT_1_CHANNEL     (1)
#define AI_SINE_AI_OUT_1_SIZE        (1)
#define AI_SINE_AI_OUT_1_SIZE_BYTES  (AI_SINE_AI_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_AI_N_NODES (5)
 ...
 */
AI_API_ENTRY
ai_error ai_sine_ai_get_error(ai_handle network);
 ...
 * using @ref ai_sine_ai_get_error
 */
AI_API_ENTRY
ai_bool ai_sine_ai_init(
 ...
 * header generated by the code generation tool. See AI_SINE_AI_*
 * defines into file @ref sine_ai.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
