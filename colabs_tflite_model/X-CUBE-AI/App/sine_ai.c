...
#define AI_NET_OBJ_INSTANCE g_sine_ai
 
#undef AI_SINE_AI_MODEL_SIGNATURE
#define AI_SINE_AI_MODEL_SIGNATURE     "adf1c3694ad8f0a4d7da188d323666df"
...
#define AI_TOOLS_DATE_TIME   "Tue Dec  7 13:30:20 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SINE_AI_N_BATCHES
#define AI_SINE_AI_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 128, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_AI_IN_NUM, &serving_default_dense_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_AI_OUT_NUM, &dense_2_output),
  &dense_0_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool sine_ai_configure_activations(
...
AI_DECLARE_STATIC
ai_bool sine_ai_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  AI_UNUSED(net_ctx)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SINE_AI_MODEL_NAME,
      .model_signature   = AI_SINE_AI_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= sine_ai_configure_weights(net_ctx, params);
  ok &= sine_ai_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_sine_ai_forward(ai_handle network, const ai_buffer* input)
{
