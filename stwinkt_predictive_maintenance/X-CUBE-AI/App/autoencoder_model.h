...
#ifndef AI_AUTOENCODER_MODEL_H
#define AI_AUTOENCODER_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_AUTOENCODER_MODEL_MODEL_NAME          "autoencoder_model"
#define AI_AUTOENCODER_MODEL_ORIGIN_MODEL_NAME   "encoder_model"

/******************************************************************************/
#define AI_AUTOENCODER_MODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_AUTOENCODER_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_AUTOENCODER_MODEL_IN \
  ai_autoencoder_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUTOENCODER_MODEL_IN_SIZE { \
  AI_AUTOENCODER_MODEL_IN_1_SIZE, \
}
#define AI_AUTOENCODER_MODEL_IN_SIZE_BYTES { \
  AI_AUTOENCODER_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_AUTOENCODER_MODEL_IN_1_CHANNEL     (400)
#define AI_AUTOENCODER_MODEL_IN_1_SIZE        (400)
#define AI_AUTOENCODER_MODEL_IN_1_SIZE_BYTES  (1600)

/******************************************************************************/
#define AI_AUTOENCODER_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AUTOENCODER_MODEL_OUT \
  ai_autoencoder_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUTOENCODER_MODEL_OUT_SIZE { \
  AI_AUTOENCODER_MODEL_OUT_1_SIZE, \
}
#define AI_AUTOENCODER_MODEL_OUT_SIZE_BYTES { \
  AI_AUTOENCODER_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_AUTOENCODER_MODEL_OUT_1_CHANNEL     (400)
#define AI_AUTOENCODER_MODEL_OUT_1_SIZE        (400)
#define AI_AUTOENCODER_MODEL_OUT_1_SIZE_BYTES  (1600)

/******************************************************************************/
#define AI_AUTOENCODER_MODEL_N_NODES (16)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup autoencoder_model
 ...
 * @ref ai_autoencoder_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_autoencoder_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_autoencoder_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_autoencoder_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AUTOENCODER_MODEL_*
 * defines into file @ref autoencoder_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_autoencoder_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_AUTOENCODER_MODEL_H */
