...
//     ai_output[0].data = AI_HANDLE_PTR(out_data);
    ...
    PREDMNT1_PRINTF(" --------- AUTOENCODER_MODEL EXAMPLE ------------\r\n");
    PREDMNT1_PRINTF(" ---------   PREDICTIVE MAINTENANCE  ------------\r\n");
...
//     LedOnTargetPlatform();
//     uint32_t i = 0; 
//     while( i < AI_AUTOENCODER_MODEL_IN_1_SIZE )
//     {
//         if(SendAccGyroMag) {
//             SendAccGyroMag=0;
//             SendMotionData();
...
//         y_val = ((float *)out_data)[0];
        ...
        // TODO: set timer to calculate inference time
